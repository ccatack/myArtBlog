            ...
            <section className="recent-section">
                <div>
                    ...
                    <div className="overlay-container">
                        <img src={"/myArtBlog" + mostRecent[0].image}></img>
            ...
            <section className="about-section" ref={aboutRef} id="about">
                <div className="about-links">
                    <button onClick={() => {window.open("https://www.linkedin.com/in/corbin-atack/", '_blank');}} title="LinkedIn">
                        <img src="/myArtBlog/images/linkedinIcon.png"></img>
                    </button>
                    <button onClick={() => {window.open("https://github.com/ccatack", '_blank');}} title="GitHub">
                    <img src="/myArtBlog/images/githubIcon.png" className="github-icon"></img>
                    </button>
                    <button onClick={() => handleEmailClick()} title="Copy Email">
                        <img src="/myArtBlog/images/emailIcon.png" className="email-button"></img>
                    </button>
                </div>
                <div className="about-pieces">
                    <img src="/myArtBlog/images/sprites/frisbPlayer.png"></img>
